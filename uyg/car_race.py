...
while time.time() - start_time < timer:
 ...
 image= Image.open("backroad.jpeg")
 image.save("backroad.gif")
 
 screen=turtle.Screen()
 screen.title("Racing Car")
 screen.setup(width=675 , height=700)
 screen.bgcolor("black")
 screen.tracer(0)
 screen.register_shape('backroad.gif')
 screen.register_shape('racingcar.gif')
 screen.addshape("backroad.gif")
 turtle.shape("backroad.gif")
 ...
 for i in range(10):
    ...
    second_obstacle_x=random.randint(-180,180)
